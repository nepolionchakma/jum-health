            ...
            <div className="row m-0 p-5">
                ...
                <div className="col-lg-3 p-3 ">
                    <div className="shadow rounded p-3">
                        ...
                        <p className="mt-3">Our recently edited compendium ‘Health Systems Improvement Across the Globe: Success Stories from 60 Countries’ [4] takes on the task of examining health reform achievement narratives drawing on data from 60 countries, and offering a unique global perspective. It seeks to understand how different health systems, sectors or sub-sectors experience success with health reform. </p>
                    </div>
                </div>
                <div className="col-lg-3 p-3">
                    <div className="shadow rounded p-3">
                        ...
                        <p className="mt-3">There are many types of health care professionals. Traditional roles and responsibilities held by physicians and nurses have changed, along with the expansion of technology and the demand for health care services. The education, certifications, and licensures for types of health care practitioners differ, as does their scope of practice (what they are allowed by law to do for patients). The December 5, 2012, issue of JAMA is a theme issue on medical education.</p>
                    </div>
                </div>
                <div className="col-lg-3 p-3">
                    <div className="shadow rounded p-3">
